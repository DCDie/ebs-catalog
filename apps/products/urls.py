...
base_router.register(
    prefix="shop-products", viewset=ProductShopViewSet, basename="shop_products"
)
base_router.register(
    prefix="attachments", viewset=AttachmentViewSet, basename="attachments"
)
...
base_router.register(
    prefix="shop-categories", viewset=ShopCategoryViewSet, basename="shop-categories"
)

...
class Category(BaseModel):
    ...
    attachments = models.ManyToManyField(
        "Attachment", related_name="category_attachments", blank=True
    )
...
class Comment(BaseModel):
    ...
    product = models.ForeignKey(
        to=Product, on_delete=models.CASCADE, blank=True, null=True
    )
    shop = models.ForeignKey(
        to="Shop", on_delete=models.SET_NULL, blank=True, null=True
    )
    user = models.ForeignKey(to=User, null=True, blank=True, on_delete=models.CASCADE)
    languages = models.JSONField(blank=True, null=True)
    attachments = models.ManyToManyField(
        "Attachment", related_name="comment_attachments", blank=True
    )
    rating = models.IntegerField(
        default=0,
        blank=True,
...
class Shop(BaseModel):
    ...
    shop_detail = models.JSONField(null=True, blank=True)
    languages = models.JSONField(blank=True, null=True)
    attachments = models.ManyToManyField(
        "Attachment", related_name="shop_attachments", blank=True
    )
...
class ShopProduct(BaseModel):
    ...
    label = AutoSlugField(
        primary_key=True, populate_from=("shop__title", "title"), allow_duplicates=True
    )
    title = models.CharField(max_length=155)
    description = models.TextField(null=True, blank=True)
    price = models.DecimalField(max_digits=9, decimal_places=2)
    ...
    attachments = models.ManyToManyField(
        "Attachment", related_name="product_shop_attachments", blank=True
    )
    ...
    shop_category = models.ForeignKey(to="ShopCategory", on_delete=models.CASCADE)
    category = models.ManyToManyField(Category)
    verified = models.BooleanField(blank=True, null=True, default=False)
...
class Brand(BaseModel):
    ...
    languages = models.JSONField(blank=True, null=True)
    attachments = models.ManyToManyField(
        "Attachment", related_name="brand_attachments", blank=True
    )
...
class Attachment(BaseModel):
    ...
    file_url = models.FileField(blank=True)

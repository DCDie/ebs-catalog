...
class FoxmartParser:
    ...
    def get_categories(self) -> None:
        ...
        with open(
            f"{self.path}/foxmart_categories.json", "w", encoding="utf-8"
        ) as file:
    ...
    def get_products(self) -> None:
        ...
        for subcategory in categories:
            ...
            while True:
                start = time.process_time()
                url = (
                    f"https://www.foxmart.md/api/client/products/catalog?items=15&"
                ...
                page += 1
                with open(
                    f"{self.path}/foxmart_items_{category}.json", "w+", encoding="utf-8"
                ) as file:
